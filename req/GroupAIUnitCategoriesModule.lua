...
function GroupAIUnitCategoriesModule.streamlined_heisting(tweak_data_group_ai, difficulty_index)
...
function GroupAIUnitCategoriesModule.vanilla(tweak_data_group_ai, difficulty_index)
	if not difficulty_index then
		log("[ASS] Variable 'difficulty_index' does not exist")
		return
	end
...
GroupAIUnitCategoriesModule.beta_streamlined_heisting = GroupAIUnitCategoriesModule.streamlined_heisting
