...
function MoonTweakData:init_spawn_group_mapping()
	self.spawn_group_mapping = {
		tac_swat_rifle_flank = {
			...
			"chicken_plate_hrt",
			"chicken_plate_assault_ar_smg",
			"chicken_plate_assault_smg_sg",
		},
		tac_shield_wall = {
...
function MoonTweakData:init_weapon_mapping()
	local enemy_weapon_tweaks = {
		shield = {
			default = {
				...
				russia_c45 = nil,
				russia_sr2 = "sr2_smg",
				murkywater = real_difficulty_index > 3 and "mp9" or nil,
				federales_c45 = nil,
				federales_mp9 = "mp9",
			...
			both = {
				...
				city = nil,
				zeal = nil,
				russia_c45 = { "c45", "sr2_smg", },
				russia_sr2 = { "c45", "sr2_smg", },
				murkywater = nil,
				federales_c45 = nil,
				federales_mp9 = nil,
		...
		medic_rifle = {
			...
			both = {
				swat = { "mp5", "deagle", },
				fbi = { "m4", "deagle", },
				zeal = { "shepheard", "deagle", },
				russia = { "ak47_ass", "deagle", },
				murkywater = { "scar_murky", "deagle", },
				federales = nil,
				constantine_cartel = { "sg417", "deagle", },
				bo_ovk = { "m4", "deagle", },
			},
		},
		medic_shotgun = {
		...
		pistol_rifle_hrts = {
			...
			both = {
				...
				fbi = { "c45", "m4", },
				fbi_rifle = { "c45", "m4", },
				russia_pistol = { "c45", "akmsu_smg", },
				russia_rifle = { "c45", "akmsu_smg", },
				murkywater = { "c45", "scar_murky", },
				federales = nil,
				constantine_fsb = { "c45", "akmsu_smg", },
				constantine_cartel_pistol = { "beretta92", "ak47", },
				constantine_cartel_rifle = { "beretta92", "ak47", },
				bo_sbz_pistol = { "c45", "shepheard", },
				bo_sbz_rifle = { "c45", "shepheard", },
				bo_ovk_pistol = { "c45", "m4", },
				bo_ovk_rifle = { "c45", "m4", },
			},
		},
		shotgun_revolver_hrts = {
			default = {
				swat = "r870",
				swat_bronco = "raging_bull",
				fbi = "spas12",
				russia_bronco = "raging_bull",
				russia_shotgun = nil,
				murkywater = "spas12",
				federales = nil,
				constantine_fsb = nil,
			...
			both = {
				swat = { "r870", "raging_bull", },
				swat_bronco = nil,
				fbi = { "spas12", "raging_bull", },
				russia_bronco = nil,
				russia_shotgun = nil,
	...
	local level_overrides = {
		...
		flat = {
			...
			[("units/payday2/characters/ene_gang_black_2/ene_gang_black_2"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_black_3/ene_gang_black_3"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_black_4/ene_gang_black_4"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_mexican_1/ene_gang_mexican_1"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_mexican_2/ene_gang_mexican_2"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_mexican_3/ene_gang_mexican_3"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_mexican_4/ene_gang_mexican_4"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_russian_1/ene_gang_russian_1"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_russian_2/ene_gang_russian_2"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_russian_3/ene_gang_russian_3"):key()] = clone(panic_room),
			[("units/payday2/characters/ene_gang_russian_4/ene_gang_russian_4"):key()] = clone(panic_room),
	...
	local weapon_mapping = {
		...
		[("units/pd2_dlc_casino/characters/ene_secret_service_1_casino/ene_secret_service_1_casino"):key()] = clone(c45_ump),
		...
		[("units/payday2/characters/ene_murkywater_1/ene_murkywater_1"):key()] = clone(murkywater),
		[("units/payday2/characters/ene_murkywater_2/ene_murkywater_2"):key()] = clone(murkywater),
		[("units/pd2_dlc_berry/characters/ene_murkywater_no_light/ene_murkywater_no_light"):key()] = clone(murkywater),
		[("units/pd2_dlc_des/characters/ene_murkywater_not_security_1/ene_murkywater_not_security_1"):key()] = clone(murkywater),
		[("units/pd2_dlc_des/characters/ene_murkywater_not_security_2/ene_murkywater_not_security_2"):key()] = clone(murkywater),
		[("units/pd2_dlc_des/characters/ene_murkywater_no_light_not_security/ene_murkywater_no_light_not_security"):key()] = clone(murkywater),
		...
		[("units/pd2_dlc_fex/characters/ene_secret_service_fex/ene_secret_service_fex"):key()] = clone(c45_ump),
