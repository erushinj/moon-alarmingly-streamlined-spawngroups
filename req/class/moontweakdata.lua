...
function MoonTweakData:init_weapon_mapping()
	...
	local weapon_mapping = {
		...
		[("units/payday2/characters/ene_cop_4/ene_cop_4"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "swat"),
		[("units/payday2/characters/ene_fbi_1/ene_fbi_1"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "fbi"),
		[("units/payday2/characters/ene_fbi_2/ene_fbi_2"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "fbi"),
		[("units/pd2_dlc_rvd/characters/ene_la_cop_1/ene_la_cop_1"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "swat"),
		[("units/pd2_dlc_rvd/characters/ene_la_cop_4/ene_la_cop_4"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "swat"),
		...
		[("units/pd2_dlc_hvh/ene_cop_hvh_4/ene_cop_hvh_4"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "swat"),
		[("units/pd2_dlc_hvh/ene_fbi_hvh_1/ene_fbi_hvh_1"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "fbi"),
		[("units/pd2_dlc_hvh/ene_fbi_hvh_2/ene_fbi_hvh_2"):key()] = get_tweaked_weapon("pistol_rifle_hrts", "fbi"),
