...
function GroupAIUnitCategories.moon_style_streamlined(group_ai, difficulty_index, special_difficulty_index)
	if difficulty_index < 4 then
		...
		group_ai.unit_categories.CS_cop_C45_R870.unit_types.zombie = {
...
function GroupAIUnitCategories.moon_style_vanilla(group_ai, difficulty_index, special_difficulty_index)
	...
	elseif difficulty_index > 7 then
		group_ai.unit_categories.FBI_tank.unit_types.zombie = {
...
GroupAIUnitCategories.van_style_streamlined = GroupAIUnitCategories.moon_style_streamlined
GroupAIUnitCategories.van_style_vanilla = GroupAIUnitCategories.moon_style_vanilla
...
function GroupAIUnitCategories.FBI_mcmansion(group_ai)
	GroupAIUnitCategories.FBI_hard(group_ai)
...
function GroupAIUnitCategories.CITY_overkill(group_ai)
	group_ai.unit_categories.CS_cop_C45_R870.unit_types.america = {
		Idstring("units/payday2/characters/ene_fbi_1/ene_fbi_1"),
		Idstring("units/payday2/characters/ene_fbi_2/ene_fbi_2"),
		Idstring("units/payday2/characters/ene_fbi_3/ene_fbi_3")
