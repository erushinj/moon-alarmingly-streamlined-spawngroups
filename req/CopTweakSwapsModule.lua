local CopBaseTweakSwapsModule = {}

function CopBaseTweakSwapsModule.streamheist()
	return {
		swaps = {},
		override = {}
	}
...
-- TODO :  update overrides for tweak table swaps
function CopBaseTweakSwapsModule.vanilla()
...
CopBaseTweakSwapsModule.beta_streamheist = CopBaseTweakSwapsModule.streamheist
CopBaseTweakSwapsModule.beta_vanilla = CopBaseTweakSwapsModule.vanilla

return CopBaseTweakSwapsModule