return {
	...
	-- offices
	[101620] = { enemy = ASS:random_unit("securitys") },
	...
	-- no idea where these guys go, unused ?  stealth only ?
	[103209] = { enemy = ASS:random_unit("securitys") },
	...
	-- every other guard
	[101646] = { enemy = ASS:random_unit("securitys_heavy") },
