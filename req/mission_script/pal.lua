return {
	-- van swats
	[100770] = { enemy = ASS:random_unit("swats"), },  -- van 1
	...
	[100779] = { enemy = ASS:random_unit("swats"), },  -- van 2
	...
	[100797] = { enemy = ASS:random_unit("swats"), },  -- van 3
	...
	[100829] = { enemy = ASS:random_unit("swats"), },  -- van 4
	...
	-- crashed van
	[101652] = { enemy = ASS:random_unit("specials_def"), },  -- shields
	...
	[101651] = { enemy = ASS:random_unit("dozers_no_med"), },  -- dozers
