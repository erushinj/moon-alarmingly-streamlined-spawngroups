...
local low_diff_harassers = ASS:random_unit(normal and "swats" or hard and "swats_heavys" or "heavys")
local high_diff_harassers = ASS:random_unit(normal and "swats_heavys" or "heavys")
