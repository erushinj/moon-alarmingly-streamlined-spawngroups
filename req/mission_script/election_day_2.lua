return {
	...
	-- "topside" guards
	[100605] = { enemy = ASS:random_unit("securitys_light") },
	...
	-- patrolling guards
	[100670] = { enemy = ASS:random_unit("securitys_heavy") },
	...
	-- normal harasser spawns (swat heavies, should be light swats)
	[102732] = { enemy = ASS:random_unit("swats") },
	[102428] = { enemy = ASS:random_unit("swats") },
	[102444] = { enemy = ASS:random_unit("swats") },
	[102460] = { enemy = ASS:random_unit("swats") },
	[102762] = { enemy = ASS:random_unit("swats") },
	[102778] = { enemy = ASS:random_unit("swats") },
	[102794] = { enemy = ASS:random_unit("swats") },
	[102810] = { enemy = ASS:random_unit("swats") },
	[102826] = { enemy = ASS:random_unit("swats") },

	-- hard/very hard harasser spawns (fbi swats)
	[102733] = { enemy = ASS:random_unit("swats_heavys") },
	[102429] = { enemy = ASS:random_unit("swats_heavys") },
	[102445] = { enemy = ASS:random_unit("swats_heavys") },
	[102461] = { enemy = ASS:random_unit("swats_heavys") },
	[102763] = { enemy = ASS:random_unit("swats_heavys") },
	[102779] = { enemy = ASS:random_unit("swats_heavys") },
	[102795] = { enemy = ASS:random_unit("swats_heavys") },
	[102811] = { enemy = ASS:random_unit("swats_heavys") },
	[102827] = { enemy = ASS:random_unit("swats_heavys") },

	-- overkill and above harasser spawns (fbi heavies)
	[102742] = { enemy = ASS:random_unit("heavys") },
	[102430] = { enemy = ASS:random_unit("heavys") },
	[102446] = { enemy = ASS:random_unit("heavys") },
	[102462] = { enemy = ASS:random_unit("heavys") },
	[102764] = { enemy = ASS:random_unit("heavys") },
	[102780] = { enemy = ASS:random_unit("heavys") },
	[102796] = { enemy = ASS:random_unit("heavys") },
	[102812] = { enemy = ASS:random_unit("heavys") },
	[102828] = { enemy = ASS:random_unit("heavys") },
